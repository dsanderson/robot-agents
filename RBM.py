...
class RBM(object):
    ...
    def _run_train_step(self, train_set):
        ...
        batches = [_ for _ in RBM_utils.gen_batches(train_set, self.batch_size)]
    ...
    def sample_hidden_from_visible(self, visible):
        ...
        hstates = RBM_utils.sample_prob(hprobs, self.hrand)
    ...
    def get_weights_as_images(self, width, height, outdir='img/', n_images=10, img_type='grey'):
        ...
        with tf.Session() as self.tf_session:
            ...
            for p in perm:
                ...
                RBM_utils.gen_image(w, width, height, image_path, img_type)

    def update(self, data, name='train'):
        ...
        with tf.Session() as self.tf_session:
            ...
            vis = self.sample_visible_from_hidden(encoded_data)
            out = vis.eval()
